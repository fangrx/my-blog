                ...
                ,function(){
                    if(options.isJump && item.href){
                        if(!item.target)
                            item.target='_self'  ;
                        if(item.selected){
                            return '<a href="'+ item.href +'" target="'+item.target + '" class="'+ ELEM_TEXT +'" style="color:#5FB878 ">'+ (item.title || item.label || options.text.defaultNodeName) +'</a>';
                        }
                        return '<a href="'+ item.href +'" target="'+item.target + '" class="'+ ELEM_TEXT +'">'+ (item.title || item.label || options.text.defaultNodeName) +'</a>';
