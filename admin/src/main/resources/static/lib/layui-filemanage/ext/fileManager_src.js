            ...
            switch (v.type) {
                ...
                default:
                    ...
                    if (v.type == 'png' || v.type == 'gif' || v.type == 'jpg' || v.type == 'image') {
                        ...
                        _img = '<div  style="width:'+options.thumb['width']+'px;height:'+options.thumb['height']+'px;line-height:'+options.thumb['height']+'px"><img src="' + options.icon_url + v.type + '.png" style="width: 56px;height: 56px" onerror=\'this.src="'+options.thumb['nopic']+'"\' /></div>';
                    }
                    break;
            }
