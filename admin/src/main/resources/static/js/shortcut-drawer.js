...
Win10.onReady(function () {
   ...
   $('body').on('click','.win10-drawer',function () {
       ...
       var _this = $(this);
       $(this).children('i').removeClass('fa fa-folder-o');
       $(this).children('i').addClass('fa fa-folder-open-o');
       var index=layer.open({
           ...
           content: content,
               ...
               _this.children('i').removeClass('fa fa-folder-open-o');
               _this.children('i').addClass('fa fa-folder-o');
