...
import com.nonelonely.admin.system.validator.DictValid;
...
import com.nonelonely.modules.system.domain.Dict;
import com.nonelonely.modules.system.domain.permission.NBAuth;
import com.nonelonely.modules.system.service.DictService;
...
public class DictController {
    ...
    @NBAuth(value = "system:dict:add", remark = "字典列表页面", type = OTHER, group = ROUTER)
    ...
    @NBAuth(value = "system:dict:add", remark = "字典添加页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:dict:edit", remark = "字典编辑页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:dict:detail", remark = "字典详细页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:dict:status", remark = "字典状态", type = NAV_LINK, group = ROUTER)
