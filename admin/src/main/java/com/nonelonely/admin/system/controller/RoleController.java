...
public class RoleController {
    ...
    @NBAuth(value = "system:role:index", remark = "角色列表页面", type = OTHER, group = ROUTER)
    ...
    @NBAuth(value = "system:role:add", remark = "角色添加页面", type = NAV_LINK, group = ROUTER)
    public String toAdd(){
    ...
    @NBAuth(value = "system:role:edit", remark = "角色编辑页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:role:auth", remark = "角色授权页面", type = NAV_LINK, group = ROUTER)
...
//        roleService.save(role);
    ...
    @ActionLog(name = "跳转到详细页面", action = StatusAction.class)
    @NBAuth(value = "system:role:detail", remark = "角色详细页面", type = NAV_LINK, group = ROUTER)
    ...
    @RequiresPermissions("system:role:detail")
    @ActionLog(name = "角色的用户列表页面", action = StatusAction.class)
    ...
    @NBAuth(value = "system:role:status", remark = "修改角色状态", type = NAV_LINK, group = ROUTER)
