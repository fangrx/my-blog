...
public class UserController {
    ...
    @NBAuth(value = "system:user:index", remark = "用户列表页面", type = OTHER, group = ROUTER)
    ...
    @NBAuth(value = "system:user:add", remark = "用户添加页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:user:edit", remark = "用户编辑页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:user:detail", remark = "用户详细页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:user:pwd", remark = "用户修改密码页面", type = NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "system:user:role", remark = "用户角色分配页面", type = NAV_LINK, group = ROUTER)
    ...
    @ResponseBody
    @NBAuth(value = "system:user:status", remark = "用户数据状态", type = NAV_LINK, group = ROUTER)
