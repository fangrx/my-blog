...
public interface ResourceRepository extends BaseRepository<NBSysResource, Long> {
     ...
     * @return
     */
    @Query("SELECT r FROM NBSysResource r WHERE r.id IN (?1)")
    List<NBSysResource> findAllByIdIn(List<Long> ids);
