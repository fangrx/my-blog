...
public interface MenuRepository extends BaseRepository<Menu, Long> {
     ...
     * @return 菜单列表
     */
    public List<Menu> findAllByStatusAndType(Sort sort, Byte status, Byte type);
     ...
     * @return 菜单列表
     */
    public List<Menu> findByPidAndIdNotAndType(Sort sort, long pid, long notId, Byte type);
